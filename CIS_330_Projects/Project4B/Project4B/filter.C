...
Shrinker::Execute()
{
	this->GetOutput()->ResetSize(this->GetImg1()->GetWidth()/2 , this->GetImg1()->GetHeight()/2);
...
LRCombine::Execute()
{
	this->GetOutput()->ResetSize(this->GetImg1()->GetWidth() + this->GetImg2()->GetWidth(), this->GetImg1()->GetHeight());
...
TBCombine::Execute()
{
	this->GetOutput()->ResetSize(this->GetImg1()->GetWidth(), this->GetImg1()->GetHeight() + this->GetImg2()->GetHeight());
...
Blender::Execute()
{
	this->GetOutput()->ResetSize(this->GetImg1()->GetWidth(), this->GetImg1()->GetHeight());
